  ...
  toc: [
    ...
    },
    {
      ...
      items: [
        ...
        { file: 'part3/domain-model.adoc', text: '12장 도메인을 표에 담기: 학습 상태와 덱 주소' },
        {
          file: 'part3/code-map.adoc',
          text: '13장 코드는 어디에 있는가: 패키지 지도와 앱의 시작점',
        },
        {
          file: 'part3/go.adoc',
          text: '14장 핵심 로직 읽기: 간격 반복 알고리즘과 도메인 코드',
        },
        { file: 'part3/go-testing.adoc', text: '15장 Go 테스트와 품질 검사 도구' },
        { file: 'part3/gin.adoc', text: '16장 Gin으로 만드는 HTTP API: 라우팅·바인딩·미들웨어' },
        { file: 'part3/app-assembly.adoc', text: '17장 앱을 조립하기: 계층 분리와 두 진입점' },
        {
          file: 'part3/html-css.adoc',
          text: '18장 화면의 구조: 템플릿 삼층과 스타일 시스템',
        },
        { file: 'part3/go-templates.adoc', text: '19장 html/template으로 만드는 화면' },
        { file: 'part3/htmx.adoc', text: '20장 htmx: 자바스크립트 없이 만드는 동적 화면' },
        {
          file: 'part3/app-tests.adoc',
          text: '21장 앱을 통째로 띄우는 테스트: 화면과 API를 한 번에 검증하기',
        },
        { file: 'part3/local-dev.adoc', text: '22장 로컬 개발 환경: 무설정 실행의 원리와 개발 도구' },
      ],
    },
    {
      text: '4부 세상에 공개하기',
      items: [
        { file: 'part4/git.adoc', text: '23장 Git: 개념과 브랜치 정책' },
        { file: 'part4/quality-gates.adoc', text: '24장 품질 게이트: 훅과 서브에이전트' },
        { file: 'part4/github-actions.adoc', text: '25장 GitHub Actions: 원격 품질 게이트' },
        { file: 'part4/vercel.adoc', text: '26장 Vercel: 왜 이 플랫폼이고, 무엇이 배포되는가' },
        {
          file: 'part4/vercel-config.adoc',
          text: '27장 Vercel 설정과 제약: vercel.json, 콜드스타트, 배포 절차',
        },
        { file: 'part4/supabase-auth.adoc', text: '28장 Supabase 인증: OAuth 로그인과 쿠키 세션' },
        { file: 'part4/token-verification.adoc', text: '29장 토큰 검증의 원리: JWT와 JWKS' },
        {
          file: 'part4/supabase-db.adoc',
          text: '30장 Supabase 데이터베이스: pgx 연결과 커넥션 풀',
        },
        { file: 'part4/migrations.adoc', text: '31장 마이그레이션: 운영 중에 스키마를 고친다' },
      ],
    },
    {
      text: '5부 안정적으로 오래 운영하기',
      items: [
        { file: 'part5/env-secrets.adoc', text: '32장 환경 변수와 시크릿: 값이 두 벌이 된다' },
        { file: 'part5/pwa.adoc', text: '33장 PWA: 설치되는 앱으로 만들기' },
        { file: 'part5/caching.adoc', text: '34장 캐시와 서비스 워커: 낡은 화면이 남지 않게' },
        { file: 'part5/free-tier.adoc', text: '35장 무료 티어 운영과 한도 관리' },
        { file: 'part5/whats-next.adoc', text: '36장 다음 단계: 여기서 더 공부할 것들' },
      ],
    },
    {
      text: '부록',
