  ...
  toc: [
    {
      ...
      items: [
        ...
        { file: 'how-to-read.adoc', text: '이 책을 읽는 법', pdfPart: '읽는 법' },
        {
          ...
          text: '무엇을 만드는가: Flashcard의 기능과 비기능 요구사항',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          text: '4장 개발 도구 설치와 첫 실행: 깔고, 받고, 띄운다',
        },
      ],
    },
    {
      ...
      items: [
        { file: 'part2/html-hello.adoc', text: '5장 HTML 첫걸음: 파일 하나로 만드는 웹 문서' },
        { file: 'part2/css-hello.adoc', text: '6장 CSS 첫걸음: 색과 배치를 입히는 규칙' },
        { file: 'part2/go-hello.adoc', text: '7장 Go 첫걸음: Hello, World로 배우는 기본 문법' },
        { file: 'part2/go-types.adoc', text: '8장 Go로 데이터 다루기: 구조체, 슬라이스와 맵' },
        { file: 'part2/database-basics.adoc', text: '9장 데이터베이스 기초: 테이블, SQL, 인덱스' },
      ],
    },
    {
      text: '3부 앱 코드 해부: 데이터에서 화면까지',
      items: [
        { file: 'part3/database.adoc', text: '10장 데이터베이스 설계: 요구사항에서 테이블로' },
        { file: 'part3/domain-model.adoc', text: '11장 도메인을 표에 담기: 학습 상태와 덱 주소' },
        ...
        { file: 'part3/gin.adoc', text: '15장 Gin으로 만드는 HTTP API: 라우팅·바인딩·미들웨어' },
        { file: 'part3/app-assembly.adoc', text: '16장 앱을 조립하기: 계층 분리와 두 진입점' },
        { file: 'part3/html-css.adoc', text: '17장 HTML과 CSS: 화면을 이루는 문서와 스타일' },
        { file: 'part3/go-templates.adoc', text: '18장 html/template으로 만드는 화면' },
        { file: 'part3/htmx.adoc', text: '19장 htmx: 자바스크립트 없이 만드는 동적 화면' },
        {
          file: 'part3/app-tests.adoc',
          text: '20장 앱을 통째로 띄우는 테스트: 화면과 API를 한 번에 검증하기',
        },
        { file: 'part3/local-dev.adoc', text: '21장 로컬 개발 환경: 무설정 실행의 원리와 개발 도구' },
      ],
    },
    {
      text: '4부 세상에 공개하기',
      items: [
        { file: 'part4/git.adoc', text: '22장 Git: 개념과 브랜치 정책' },
        { file: 'part4/quality-gates.adoc', text: '23장 품질 게이트: 훅과 서브에이전트' },
        { file: 'part4/github-actions.adoc', text: '24장 GitHub Actions: 원격 품질 게이트' },
        { file: 'part4/vercel.adoc', text: '25장 Vercel: 왜 이 플랫폼이고, 무엇이 배포되는가' },
        {
          file: 'part4/vercel-config.adoc',
          text: '26장 Vercel 설정과 제약: vercel.json, 콜드스타트, 배포 절차',
        },
        { file: 'part4/supabase-auth.adoc', text: '27장 Supabase 인증: OAuth 로그인과 쿠키 세션' },
        { file: 'part4/token-verification.adoc', text: '28장 토큰 검증의 원리: JWT와 JWKS' },
        {
          file: 'part4/supabase-db.adoc',
          text: '29장 Supabase 데이터베이스: pgx 연결과 커넥션 풀',
        },
        { file: 'part4/migrations.adoc', text: '30장 마이그레이션: 운영 중에 스키마를 고친다' },
      ],
    },
    {
      text: '5부 안정적으로 오래 운영하기',
      items: [
        { file: 'part5/env-secrets.adoc', text: '31장 환경 변수와 시크릿: 값이 두 벌이 된다' },
        { file: 'part5/pwa.adoc', text: '32장 PWA: 설치되는 앱으로 만들기' },
        { file: 'part5/caching.adoc', text: '33장 캐시와 서비스 워커: 낡은 화면이 남지 않게' },
        { file: 'part5/free-tier.adoc', text: '34장 무료 티어 운영과 한도 관리' },
        { file: 'part5/whats-next.adoc', text: '35장 다음 단계: 여기서 더 공부할 것들' },
      ],
    },
    {
      text: '부록',
