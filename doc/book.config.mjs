    ...
    },
    {
      ...
      items: [
        ...
        { file: 'part3/htmx.adoc', text: '18장 htmx: 자바스크립트 없이 만드는 동적 화면' },
        {
          ...
          text: '19장 앱을 통째로 띄우는 테스트: 화면과 API를 한 번에 검증하기',
        },
        { file: 'part3/local-dev.adoc', text: '20장 로컬 개발 환경: 무설정 실행의 원리와 개발 도구' },
      ],
    },
    {
      text: '4부 세상에 공개하기',
      items: [
        { file: 'part4/git.adoc', text: '21장 Git: 개념과 브랜치 정책' },
        { file: 'part4/quality-gates.adoc', text: '22장 품질 게이트: 훅과 서브에이전트' },
        { file: 'part4/github-actions.adoc', text: '23장 GitHub Actions: 원격 품질 게이트' },
        { file: 'part4/vercel.adoc', text: '24장 Vercel: 한 플랫폼에 모두 배포하기' },
        { file: 'part4/supabase-auth.adoc', text: '25장 Supabase 인증: OAuth 로그인과 쿠키 세션' },
        { file: 'part4/token-verification.adoc', text: '26장 토큰 검증의 원리: JWT와 JWKS' },
        {
          file: 'part4/supabase-db.adoc',
          text: '27장 Supabase 데이터베이스: pgx 연결과 커넥션 풀',
        },
        { file: 'part4/migrations.adoc', text: '28장 마이그레이션: 운영 중에 스키마를 고친다' },
      ],
    },
    {
      text: '5부 안정적으로 오래 운영하기',
      items: [
        { file: 'part5/env-secrets.adoc', text: '29장 환경 변수와 시크릿: 값이 두 벌이 된다' },
        { file: 'part5/pwa.adoc', text: '30장 PWA: 설치되는 앱으로 만들기' },
        { file: 'part5/free-tier.adoc', text: '31장 무료 티어 운영과 한도 관리' },
        { file: 'part5/whats-next.adoc', text: '32장 다음 단계: 여기서 더 공부할 것들' },
      ],
    },
    {
      text: '부록',
